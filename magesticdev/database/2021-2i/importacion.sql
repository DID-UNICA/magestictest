...
alter sequence cursos_id_seq restart with 511;
alter sequence participante_curso_id_seq restart with 8507;
alter sequence profesor_curso_id_seq restart with 750;
alter sequence _evaluacion_final_curso_id_seq restart with 4952;
alter sequence _evaluacion_instructor_curso_id_seq restart with 6770;