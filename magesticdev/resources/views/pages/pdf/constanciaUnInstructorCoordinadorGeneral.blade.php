...
.tabla-centro{
  ...
  <div id=fondo>
    ...
    <table>
      ...
      <tr>
        <td width=260 class="firma" style="font-weight: bold;">{{$instructor->abreviatura_grado}} {{$instructor->nombres}} {{$instructor->apellido_paterno}} {{ $instructor->apellido_materno }}</td>
