...
<body>
  ...
  <table class="tabla-centro">
    ...
    <tr>
      <td width=230 class="firma" style="font-weight: bold;">{{$instructor1->getGrado()}} {{$instructor1->nombres}} {{$instructor1->apellido_paterno}} {{ $instructor1->apellido_materno }}</td>
      <td width=230 class="firma" style="font-weight: bold;">{{$instructor2->getGrado()}} {{$instructor2->nombres}} {{$instructor2->apellido_paterno}} {{ $instructor2->apellido_materno }}</td>
