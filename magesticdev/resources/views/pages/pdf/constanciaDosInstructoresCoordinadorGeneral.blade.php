...
<tr>
<td width=260 class="firma" style="font-weight: bold;">{{$instructor1->getGrado()}} {{$instructor1->nombres}} {{$instructor1->apellido_paterno}} {{ $instructor1->apellido_materno }}</td>
<td width=200 class="firma" style="font-weight: bold;">{{$instructor2->getGrado()}} {{$instructor2->apellido_paterno}} {{ $instructor2->apellido_materno }}</td>
