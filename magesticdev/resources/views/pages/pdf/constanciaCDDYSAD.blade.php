...
.tabla-centro{
  ...
  <div id=fondo>
    ...
    <table>
      ...
      <tr>
        <td width=260 class="firma" style="font-weight: bold;"> Mtra. Claudia Loreto Miranda</td> <!-- originalmente basado en la ConstanciaSADYDirector-->
        <td width=260 class="firma" style="font-weight: bold;"> M.E.M Margarita Ramírez Galindo</td>
        <!-- originalmente  basado en la ConstanciaSADYDirector-->
      </tr>
      <tr>
        <td class="firma" style="font-size: 10px;">Secretaria de Apoyo a la Docencia</td>
        <td class="firma" style="font-size: 10px;">Coordinadora del Centro de Docencia</td>
      </tr>
    </table>
    </div>
  </div>
