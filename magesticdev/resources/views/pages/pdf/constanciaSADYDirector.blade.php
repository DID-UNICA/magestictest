  ...
  <div id=fondo>
    ...
    <table>
      ...
      <tr>
        ...
        <td width=260 class="firma" style="font-weight: bold;">{{$direccion->grado}} {{$direccion->director }}</td>
      </tr>
      <tr>
        <td class="firma" style="font-size: 10px;">Secretaría de Apoyo a la Docencia</td>
        <td class="firma" style="font-size: 10px;">Director de la Facultad de Ingeniería</td>
      </tr>
    </table>
    </div>
  </div>
