...
.tabla-centro{
  ...
  <div id=fondo>
    ...
    <div class="centro">
      ...
      <h3 style="font-size: 12px;">Dentro del plan de becarios de UNICA, generación {{$generacion}}°</h3> <!--Checar si esnecesariocambiar h3 a div-->
    ...
    <table class="tabla-centro">
      ...
      <tr>
        <td width=260 class="firma" style="font-weight: bold;">{{$instructor1->abreviatura_grado}} {{$instructor1->nombres}} {{$instructor1->apellido_paterno}} {{ $instructor1->apellido_materno }}</td>
        <td width=200 class="firma" style="font-weight: bold;">{{$instructor2->abreviatura_grado}} {{$instructor2->apellido_paterno}} {{ $instructor2->apellido_materno }}</td>
        <td width=200 class="firma" style="font-weight: bold;">{{$coordinadorGeneral->grado}} {{$coordinadorGeneral->nombre}}</td>
      </tr>
      <tr>
