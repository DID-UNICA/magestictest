...
.tabla-centro{
  ...
  <div id=fondo>
    ...
    @endif
      ...
      <h3 style="font-size: 17px;line-height: 30%;">por impartir el {{$curso->getTipoCadena()}}</h3>
      ...
      <p style="font-size: 11px; padding-bottom: 0.35cm;">Ciudad Universitaria, Cd. Mx., {{$fecha}}</h6>
    </div>
