...
.tabla-centro{
  ...
  <div id=fondo>
    ...
    <div class="centro">
      ...
      <h3 style="font-size: 15px;line-height: 30%;">{{$texto}}</h3>
    ...
    <table class = "tabla-centro">
      ...
      <tr>
        <td  class="firma" style="font-weight: bold;">{{$nombre1}}</td>
        <td  class="firma" style="font-weight: bold;">{{$nombre2}}</td>
        <td  class="firma" style="font-weight: bold;">{{$nombre3}}</td>
        <td  class="firma" style="font-weight: bold;">{{$nombre4}}</td>
        <td  class="firma" style="font-weight: bold;">{{$nombre5}}</td>
      </tr>
      <tr>
        <td class="firma" style="font-size: 10px;">{{$cargo1}}</td>
        <td class="firma" style="font-size: 10px;">{{$cargo2}}</td>
        <td class="firma" style="font-size: 10px;">{{$cargo3}}</td>
        <td class="firma" style="font-size: 10px;">{{$cargo4}}</td>
        <td class="firma" style="font-size: 10px;">{{$cargo5}}</td>
      </tr>
    </table>
    </div>
  </div>
