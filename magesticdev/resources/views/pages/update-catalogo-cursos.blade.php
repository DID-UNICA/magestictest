...
<div class="row">
  <div class="row col-md-12 ">{!! Form::open(['route' => array('catalogo-cursos.actualizar', $user->id), "method" => "PUT"]) !!}
    ...
    <div class="form-group col-md-6">
        ...
        {!!Form::textarea("dirigido", $user->dirigido, [ "class" => "form-control"])!!}
    </div>

    <div class="form-group col-md-6 ">
        {!!Form::label("objetivo", "Objetivo:")!!}
        {!!Form::textarea("objetivo", $user->objetivo, [ "class" => "form-control"])!!}
    </div>


    <div class="form-group col-md-6">
        {!!Form::label("contenido", "Contenido:")!!}
        {!!Form::textarea("contenido", $user->contenido, [ "class" => "form-control"])!!}
    </div>
