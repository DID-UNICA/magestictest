...
copy profesors(nombres,apellido_paterno,apellido_materno,rfc,numero_trabajador,fecha_nacimiento,telefono,grado,abreviatura_grado,email,genero,baja,semblanza_corta,facebook,unam,procedencia,facultad_id) from 'E:\2021-2i\Profesores.csv' delimiter '|' csv;

--Unicamente se debe de cambiar la ruta, no se necesitan cambios en constraints
delete from cursos where id > 0;
delete from salons where id > 0;
copy salons(sede,capacidad) from 'E:\2021-2i\Sedes.csv' delimiter '#' csv;
...
copy catalogo_cursos(clave_curso,coordinacion_id,nombre_curso,tipo,antecedentes,fecha_disenio,objetivo,contenido,duracion_curso,dirigido) from 'E:\2021-2i\CatalogoCursos.csv' delimiter '|' csv;
...
alter sequence profesors_id_seq restart with 5397;