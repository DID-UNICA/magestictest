...
class Curso:
    ...
    def __init__(self,vars):
        ...
        self.fecha_inicio = vars['Fecha inicio']
        self.fecha_fin = vars['Fecha fin']
        self.hora_inicio = vars['Hora inicio']
        self.hora_fin = vars['Hora fin']
        self.dias_semana = vars['Dias']
        self.numero_sesiones = vars['No sesiones']
        self.sesiones = vars['Fecha']
        self.acreditacion = 6
        self.costo = ""
        self.cupo_maximo = vars['Cupo máximo']
        self.cupo_minimo = vars['Cupo mínimo']
        self.fecha_envio_constancia = ""
        self.fecha_envio_reconocimiento = ""
        self.num_modulo = ""
        self.catalogo_id = ""
        self.salon_id = vars['Sede']
        self.diplomado_id = ""
        self.sgc = vars['SGC']
    ...
    def __str__(self):
        ...
        toReturn += str(self.acreditacion) +"|"
        toReturn += self.costo +"|"
    ...
    def getSemestre(self):
        return self.semestre_anio+'-'+self.semestre_pi+self.semestre_si

    def getCatalogoId(self):
        return self.catalogo_id
    
    def getPK(self):
        return self.pk
    
    def getSemiPeriodo(self):
        return str(self.semestre_anio)+"-"+str(self.semestre_pi)+str(self.semestre_si)