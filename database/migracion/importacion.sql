...
copy participante_curso(id,acreditacion,asistencia,confirmacion,pago_curso,cancelacion,estuvo_en_lista,monto_pago,espera,causa_no_acreditacion,calificacion,contesto_hoja_evaluacion,curso_id,profesor_id) from 'E:\CDD\migracion\Participante_curso.csv' delimiter '|' csv;

copy profesor_curso(id,curso_id,profesor_id,tema_seminario_id,folio_inst,fecha_envio,fecha_exposicion) from 'E:\CDD\migracion\Profesor_curso.csv' delimiter ',' csv;
