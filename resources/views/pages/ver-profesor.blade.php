      ...
      <div class="panel-body">
        ...
        <div class="row col-md-12 ">
          ...
          <div class="row col-md-3 ">
            ...
            <button type='button' data-toggle="modal" data-target="#myModal{{$user->id}}" class="btn btn-danger btn-block">Dar de baja</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Está seguro de eliminar al profesor {{ $user->sede }} {{ $user->ubicacion }}?</p>
          </div>
