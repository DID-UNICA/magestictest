                ...
                @include('flash::message')
                  ...
                  <h2>Reconocimientos <span class="fa fa-file-pdf-o"</span></h2>
                      <div class="collapse navbar-collapse" id="menuCurso">
                        <form id="form" class="form-horizontal" method="POST" action="{{ route('reconocimientos.actualizarFecha', $curso->id)}}">
                        {{ csrf_field() }}
                        <div class="form-group {{ $errors->has('type') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-2">
                            <a href="{{ route('reco.elegir',[$curso->id]) }}" class="btn btn-danger">Cancelar</a></td>
                          </div>
                        </div>
                        </form>
                      </div>
