            ...
            <div class="row row-eq-height align-items-center">
              ...
              <div id="E1" class="row row-eq-height align-items-center">
                ...
                <div class='row' style='margin-top: 20px'>
                  <div class="col-md-3">
                    <label id="SemP" for="name" class="control-label">Semestre:</label>
                    {!!Form::select('Sem', array('1' => '1', '2' => '2', '3' => 'Ambos'), null, ["id" => "Sem", "class" => "form-control"]);!!}
                  </div>
                  <div class="col-md-4">
                    <label id="IOP" for="name" class="control-label">Tipo:</label>
            ...
            <div class="row row-eq-height align-items-center">
              <div id="F1" class="row row-eq-height align-items-center">
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-12">
                      <hr><label style="padding-left:10px"> Seleccionar Periodo</label><br></div>
                    <div class="col-md-4">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <select style="margin-top:10px" name="type2" class='btn dropdown-toggle pull-left' id='myselect2' onchange="deter2()">
