      ...
      @endif
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="50" class="form-check-input" {{ (old('p6_1') == '50') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="60" class="form-check-input" {{ (old('p6_1') == '60') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="80" class="form-check-input" {{ (old('p6_1') == '80') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="95" class="form-check-input" {{ (old('p6_1') == '95') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="100" class="form-check-input" {{ (old('p6_1') == '100') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                    </tr>
                    <tr>
